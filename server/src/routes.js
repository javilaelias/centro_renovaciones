...
// DELETE /api/items - Clear ALL items (must be before DELETE /:id)
...
router.get('/settings', (req, res) => {
  ...
  res.json({ success: true, data: { ...settings, smtp_pass: settings.smtp_pass ? '********' : '' } });
});

// PUT /api/settings - Update email & SMS settings
...
router.post('/settings/test', async (req, res) => {
  ...
  const testSettings = {
    ...
    smtp_pass: req.body.smtp_pass || currentSettings.smtp_pass,
...
router.post('/settings/test-sms', async (req, res) => {
  ...
  const testSettings = {
    ...
    twilio_auth_token: req.body.twilio_auth_token || currentSettings.twilio_auth_token,
